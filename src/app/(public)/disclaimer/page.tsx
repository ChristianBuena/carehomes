...
const DISCLAIMERS = [
  ...
  },
  {
    ...
    icon: Shield,
    content:
      "While this platform provides links to and references public citations from the California Department of Social Services Community Care Licensing Division (CCLD), we have no official affiliation with the CCLD. Our platform operates entirely independently to provide a voice for care facility operators.",
  },
  {
    id: "not-legal-advice",
  ...
  },
  {
    ...
    icon: AlertTriangle,
    content:
      "While we strive to provide accurate and up-to-date information, facility data (including citation status) may not be current or complete. Always verify compliance and citation information directly at official government sources, such as the CCLD public portal.",
  },
  {
    id: "member-content",
    ...
    icon: BookOpen,
    content:
      "Rebuttals published on this site are submitted by independent facility operators. While we moderate these submissions strictly for privacy and compliance (e.g., removing PII/PHI), we do not investigate, endorse, or guarantee the factual accuracy of the claims made within the rebuttals.",
  },
  {
    ...
    content:
      "Our directory of third-party service providers (e.g., consultants, legal professionals) consists of neutral listings. We do not vet, endorse, or guarantee the quality of services provided by any listed entity, nor do we collect referral fees.",
  },
  {
    id: "external-links",
      ...
      <div className="bg-[var(--color-bg)] min-h-screen pb-24">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 mt-12 mb-16">
          ...
          <div className="bg-[var(--color-primary)]/5 border border-[var(--color-border)] text-[var(--color-primary)] p-6 md:p-8 rounded-xl shadow-sm mb-12 flex flex-col md:flex-row gap-6 items-center text-center md:text-left">
            <Info
              className="h-12 w-12 shrink-0 text-[var(--color-primary)]"
              strokeWidth={2}
            />
            <div>
