    ...
    <>
      ...
      <div className="bg-[var(--color-bg)] min-h-screen pb-24 relative overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none flex items-center justify-center opacity-[0.03] z-0 rotate-[-30deg]">
          <span className="text-[15rem] font-black text-[var(--color-text)]">
            DRAFT
          </span>
        </div>
        ...
        <ResponsiveContainer className="mt-8 mb-12 relative z-10">
          <div className="bg-[var(--color-warning)]/10 border-l-4 border-[var(--color-warning)] p-6 rounded-r-lg flex gap-4 items-start shadow-sm">
            ...
            <div>
              <h2 className="text-[var(--color-text)] font-bold text-lg mb-1">
                DRAFT — Subject to attorney review before launch.
              </h2>
              <p className="text-[var(--color-text)] leading-relaxed">
                This document is a draft for planning purposes. It has not been
                reviewed by an attorney and is not legally binding. It is
                subject to formal attorney review before the official platform
                launch.
              </p>
            </div>
          </div>
            ...
            <main className="flex-1 max-w-prose bg-[var(--color-surface)] p-8 md:p-10 rounded-2xl border border-[var(--color-border)] shadow-sm">
              <div className="prose text-lg prose-slate prose-headings:text-[var(--color-primary)] prose-a:text-[var(--color-secondary)] prose-a:font-semibold hover:prose-a:text-[var(--color-primary)] prose-p:leading-relaxed prose-li:leading-relaxed break-words">
                ...
                <section id="info-we-collect" className="scroll-mt-28 mb-12">
                  ...
                  <ul>
                    <li>
                      ...
                      facility license numbers, and professional contact details
                      provided during registration.
                    </li>
                    <li>
                      <strong>Submitted Content:</strong> The text and metadata
                      of any rebuttals or documents you submit for moderation
                      and publication.
                    </li>
                    <li>
                      <strong>Usage Data:</strong> Information about how you
                      navigate and interact with our platform (IP address,
                      browser type, pages visited).
                    </li>
                    <li>
                      <strong>Payment Data:</strong> Subscription and billing
                      information securely processed via our payment provider,
                      Stripe. We do not store full credit card numbers on our
                      servers.
                    </li>
                  </ul>
                </section>
                ...
                <section id="how-we-use" className="scroll-mt-28 mb-12">
                  ...
                  <ul>
                    <li>
                      Verify facility licenses and maintain the integrity of
                      member accounts.
                    </li>
                    <li>Process payments and manage subscription renewals.</li>
                    <li>
                      Communicate with you regarding moderation decisions,
                      support inquiries, and platform updates.
                    </li>
                    <li>
                      Improve and optimize our platform's functionality and
                      security.
                    </li>
                  </ul>
                </section>
                ...
                >
                  ...
                  <p>
                    We have a strict policy regarding sensitive health data. We{" "}
                    <strong>never</strong> intentionally collect, store, or
                    publish Protected Health Information (PHI) or Personally
                    Identifiable Information (PII) of residents. If such
                    information is submitted in a draft rebuttal, our moderation
                    process intercepts and mandates the redaction or removal of
                    this data prior to publication.
                  </p>
                </section>
                ...
                <section id="data-sharing" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    ...
                    may share necessary data only with trusted third-party
                    service providers (e.g., Stripe for payment processing,
                    secure cloud hosting providers) bound by strict
                    confidentiality agreements to facilitate our platform
                    operations.
                  </p>
                </section>
                ...
                <section id="data-retention" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    We retain account information for as long as your membership
                    is active. Moderation logs and history are securely stored
                    for up to 2 years for auditing and compliance purposes. Any
                    rejected drafts containing severe privacy violations (like
                    accidental PHI inclusion) are purged from our active systems
                ...
                <section id="security" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    ...
                    security measures to protect your data. This includes
                    Multi-Factor Authentication (MFA) requirements for all
                    platform administrators and strict Role-Based Access
                    Controls (RBAC) to ensure your data is only handled by
                ...
                <section id="your-rights" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    ...
                    personal data. You may submit these requests directly to our
                    support team. We will process all valid requests in
                ...
                <section id="cookies" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    ...
                    user experience. Specifically, we utilize Google Analytics
                    (GA4) to track aggregated, anonymized usage patterns, such
                    as page views and navigation flows, to help us optimize the
                    platform. You may adjust your browser settings to decline
                ...
                <section id="childrens-privacy" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    Our platform is intended exclusively for adult professionals
                    and licensed facility operators. We do not knowingly collect
                ...
                <section id="changes" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    ...
                    changes in our practices or regulatory requirements. We will
                    notify members of significant changes via email and update
