            ...
            <main className="flex-1 max-w-prose bg-[var(--color-surface)] p-8 md:p-10 rounded-2xl border border-[var(--color-border)] shadow-sm">
              <div className="prose text-lg prose-slate prose-headings:text-[var(--color-primary)] prose-a:text-[var(--color-secondary)] prose-a:font-semibold hover:prose-a:text-[var(--color-primary)] prose-p:leading-relaxed prose-li:leading-relaxed break-words">
                ...
                <section id="eligibility" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    Membership is strictly limited to licensed California care
                    facility operators, their authorized administrators, or
                    legal representatives. By creating an account, you warrant
                    that you possess the legal authority to represent the
                    facility associated with your account.
                  </p>
                </section>

                <section id="accounts" className="scroll-mt-28 mb-12">
                  <h2 className="text-2xl font-bold mb-4">
                    4. Member Accounts & Responsibilities
                  </h2>
                  <p>
                    Members are responsible for maintaining the confidentiality
                    of their account credentials. You are legally and ethically
                    responsible for all content submitted through your account.
                    You must ensure all submissions are factually accurate to
                ...
                <section id="prohibited" className="scroll-mt-28 mb-12">
                  ...
                  <ul>
                    <li>
                      Upload any Protected Health Information (PHI) or
                      Personally Identifiable Information (PII) of residents.
                    </li>
                    <li>
                      Publish defamatory, libelous, harassing, or threatening
                      content.
                    </li>
                ...
                <section id="content-standards" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    All submissions must adhere strictly to our Redaction
                    Policy. Submissions must remain professional, objective, and
                    directly related to the specific regulatory citation being
                    addressed.
                  </p>
                </section>
                ...
                <section id="moderation" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    We reserve the right to review, reject, or remove any
                    content at our sole discretion, without prior notice, if it
                    violates these Terms or our Redaction Policy. We may also
                ...
                <section id="changes" className="scroll-mt-28 mb-12">
                  ...
                  <p>
                    ...
                    time. We will provide notice of significant changes on the
