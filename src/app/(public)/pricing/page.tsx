...
export default function PricingPage() {
  return (
    <div className="bg-[var(--color-bg)] w-full pb-24">
      {/* Page Header */}
      <header className="bg-[var(--color-primary)] text-white py-16 md:py-24 relative overflow-hidden">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[var(--color-primary)] mb-4">Pricing & Billing FAQ</h2>
          </div>
